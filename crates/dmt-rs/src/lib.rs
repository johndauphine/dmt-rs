//! # dmt-rs
//!
//! High-performance cross-database migration library (MSSQL, PostgreSQL, MySQL).
//!
//! This library provides the core functionality for migrating data between
//! Microsoft SQL Server, PostgreSQL, and MySQL with support for:
//!
...
//! - **Resume capability** via database-backed state
//! - **Type mapping** across source/target dialect pairs
//!
//! ## Example
//!
//! ```rust,no_run
//! use dmt_rs::{Config, Orchestrator};
