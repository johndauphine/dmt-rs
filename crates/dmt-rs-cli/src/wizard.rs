...
pub async fn run_wizard(output: &Path, advanced: bool, force: bool) -> WizardResult<()> {
    ...
    println!("Run 'dmt-rs run' to start the migration.");
...
fn write_config(config: &Config, path: &Path) -> WizardResult<()> {
    let header = r#"# dmt-rs Migration Configuration
# Generated by dmt-rs init
# Documentation: https://github.com/johndauphine/dmt-rs
